...
<script>
import Banner from '../../../components/frontend/show-movie/Banner'
import Detail from '../../../components/frontend/show-movie/Detail'
export default {
    ...
    async fetch() {
        ...
        let showItem = await this.$store.dispatch("loadMovieItem", data);
