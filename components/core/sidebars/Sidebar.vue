<template>
  <div class="iq-sidebar">
    <div class="iq-sidebar-logo d-flex justify-content-between">
      ...
      <div class="iq-menu-bt-sidebar">
        <div class="iq-menu-bt align-self-center">
          <div id="wrapper-menu" class="wrapper-menu" @click="miniSidebar">
    ...
    <a href="/frontend/landing-page" class="text-primary iq-visit-link"><i class="ri-arrow-left-line" /><span>visit link</span></a>
    <div id="sidebar-scrollbar">
      <nav class="iq-sidebar-menu" :class="horizontal ? 'd-xl-none' : ''">
        <CollapseMenu :items="items" :open="true" :horizontal="horizontal" :sidebar-group-title="sidebarGroupTitle" />
      </nav>
      <div class="p-3" />
    </div>
  </div>
...
export default {
  ...
  props: {
    ...
    logo: { type: String, default: require('../../../assets/images/tv-default.jpg') },
