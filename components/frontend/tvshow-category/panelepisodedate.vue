...
export default {
    ...
    async fetch() {
        ...
        let data = {
            date: Vue.prototype.getDateCalendar(subval),
        };
        this.items = await this.$store.dispatch("loadDateEpisodeList", data);
    },
    data() {
        return {
            items: [],
            ...
            yearOption: [{
                id: 0,
                value: Vue.prototype.getToday(),
                text: Vue.prototype.getToday()
            }, ],
            sliderOption: {
                dots: false,
                arrows: false,
    ...
    mounted() {
        for (let i = 1; i < 30; i++) {
            let yearItem = {
                id: i,
                value: Vue.prototype.getDateCalendar(i),
                text: Vue.prototype.getDateCalendar(i)
            };
